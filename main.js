...
function postsPrinter() {
    for (let i = 0; i < posts.length; i++) {
        postsContainer.innerHTML += postGenerator(posts[i]);
    }
}
...
for (let i = 0 ; i < likeButton.length ; i++){
    ...
    element.addEventListener('click', (event) => {
        ...
        if(element.classList.contains('like-button--liked') == false){
            ...
            postLiked.push(likeButton[i].getAttribute('data-postid'));
